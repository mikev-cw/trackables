...
<div class="page">
                            ...
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    ...
                                    <div class="dropend">
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="./auth-lock.html" class="dropdown-item"> step </a>
                                            <a href="./2-step-verification.html" class="dropdown-item"> 2 step </a>
                                            <a href="./2-step-verification-code.html" class="dropdown-item"> 2 step step </a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <header class="navbar navbar-expand-md sticky-top d-none d-print-none d-lg-flex bg-success text-white">
    ...
    <div class="page-wrapper">
        ...
        <!-- END PAGE BODY -->
        <!--  BEGIN FOOTER  -->
        <footer class="footer sticky-bottom d-print-none">
            <div class="container-xl">
