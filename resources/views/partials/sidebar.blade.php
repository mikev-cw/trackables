    ...
    <div class="container-fluid">
        ...
        <div class="navbar-brand navbar-brand-autodark">
            <a href="{{route('dashboard')}}">
                <img src="{{asset('storage/images/trackables_logo_orizontal.png')}}" width="145px" alt="{{ config('app.name') }}">
            </a>
        </div>
        <!-- END NAVBAR LOGO -->
                ...
                <li class="nav-item active">
                    ...
                    <span class="nav-link-icon d-md-none d-lg-inline-block">
                      ...
                      >
                        ...
                        <span class="nav-link-title"> Trackables </span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('trackable-groups.index')}}">
                    <span class="nav-link-icon d-md-none d-lg-inline-block">
                      <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="24"
                          ...
                          class="icon icon-1"
                      >
                        <path d="M4 6a2 2 0 0 1 2 -2h3l2 2h7a2 2 0 0 1 2 2v1h-16z" />
                        <path d="M4 9v7a2 2 0 0 0 2 2h12a2 2 0 0 0 2 -2v-7z" />
                      </svg>
                    </span>
